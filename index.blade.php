...
<center>
  ...
  <div class="col-sn-10"><h4>Registro de Turistas</h4></div>
  </center>
<div class="row">
	<div class="col-sn-2"><a class="btn btn-primary" href="{{ route('turistas.create') }}">Agregar Turista</a></div>
</div>
<br>

@forelse($turistas as $turista)
...
<center>
  ...
  <div class="row no-gutters">
    ...
    <div class="col-md-8 ">
      ...
      <a type="submit" class="btn btn-success" href="{{ route('turistas.show', $turista->id) }}">Ver</a>
...
@empty
<div><h3>No hay turistas registrados en la base de datos</h3></div>
@endforelse
